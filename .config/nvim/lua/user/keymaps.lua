...
-- Move text up and down (alt is the right alt key on my keyboard)
keymap("v", "<A-j>", ":m .+1<CR>==", opts)
keymap("v", "<A-k>", ":m .-2<CR>==", opts)
keymap("v", "p", '"_dP', opts) -- Pasting doesn't override clipboard
